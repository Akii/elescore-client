    ...
    Vue.directive('smooth-scroll', {
      inserted (el, binding) {
        ...
        el.addEventListener('click', function (ev) {
          ev.preventDefault()
          const scrollTo = document.getElementById(scrollTarget || this.hash.substring(1))
